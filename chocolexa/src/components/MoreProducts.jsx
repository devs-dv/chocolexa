...
const MoreProducts = () => {
  ...
  <div className="text-center p-10">
    <h1 className="font-bold text-4xl mb-4">Our More Products...</h1>
    <h1 className="text-3xl">Chocolexa</h1>
  </div>
    ...
    <div className="w-72 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
      <a href="#">
        ...
        <div className="px-4 py-3 w-72">
          <span className="text-gray-400 mr-3 uppercase text-xs">Chocolexa</span>
